...
BENCHMARK(bench_gift_cofb::encrypt)->Args({ 64, 64 });
BENCHMARK(bench_gift_cofb::decrypt)->Args({ 64, 64 });

BENCHMARK(bench_gift_cofb::encrypt)->Args({ 64, 128 });
BENCHMARK(bench_gift_cofb::decrypt)->Args({ 64, 128 });

BENCHMARK(bench_gift_cofb::encrypt)->Args({ 64, 256 });
BENCHMARK(bench_gift_cofb::decrypt)->Args({ 64, 256 });

BENCHMARK(bench_gift_cofb::encrypt)->Args({ 64, 512 });
BENCHMARK(bench_gift_cofb::decrypt)->Args({ 64, 512 });

BENCHMARK(bench_gift_cofb::encrypt)->Args({ 64, 1024 });
BENCHMARK(bench_gift_cofb::decrypt)->Args({ 64, 1024 });
