...
BENCHMARK(bench_elephant::jumbo_encrypt)->Args({ 64, 64 });
BENCHMARK(bench_elephant::jumbo_decrypt)->Args({ 64, 64 });


BENCHMARK(bench_elephant::jumbo_encrypt)->Args({ 64, 128 });
BENCHMARK(bench_elephant::jumbo_decrypt)->Args({ 32, 128 });

BENCHMARK(bench_elephant::jumbo_encrypt)->Args({ 64, 256 });
BENCHMARK(bench_elephant::jumbo_decrypt)->Args({ 64, 256 });

BENCHMARK(bench_elephant::jumbo_encrypt)->Args({ 64, 512 });
BENCHMARK(bench_elephant::jumbo_decrypt)->Args({ 64, 512 });

BENCHMARK(bench_elephant::jumbo_encrypt)->Args({ 64, 1024 });
BENCHMARK(bench_elephant::jumbo_decrypt)->Args({ 64, 1024 });
